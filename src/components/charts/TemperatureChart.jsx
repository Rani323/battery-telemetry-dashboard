...
export default function TemperatureChart({ data }) {
  ...
  useEffect(() => {
    ...
    series.strokes.template.setAll({ stroke: am5.color(0xf0883e), strokeWidth: 2 });

    series.bullets.push(() =>
      am5.Bullet.new(root, {
        sprite: am5.Circle.new(root, {
          radius: 3,
          fill: am5.color(0xf0883e),
  ...
  return (
    <div className="chart chart--temperature">
      <h3 className="chart__title">Battery Temperature (°C)</h3>
      <div ref={chartDivRef} className="chart__canvas" aria-label="Battery Temperature chart" />
    </div>
  );
}
