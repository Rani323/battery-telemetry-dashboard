...
export default function VoltageChart({ data }) {
  ...
  useEffect(() => {
    ...
    const series = chart.series.push(
      am5xy.LineSeries.new(root, {
        ...
        valueYField: 'voltage',
        tooltip: am5.Tooltip.new(root, { labelText: '{categoryX}: {valueY} V' }),
      })
    );
    series.strokes.template.setAll({ stroke: am5.color(0x58a6ff), strokeWidth: 2 });
  ...
  return (
    <div className="chart chart--voltage">
      <h3 className="chart__title">Battery Voltage (V)</h3>
      <div ref={chartDivRef} className="chart__canvas" aria-label="Battery Voltage chart" />
    </div>
  );
}
